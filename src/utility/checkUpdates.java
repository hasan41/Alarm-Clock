...
public class checkUpdates extends Thread{
	...
	public void run() {
		...
		try {
			...
			if(sc.nextDouble() > AlarmClock.Version){
				int result = JOptionPane.showConfirmDialog(AlarmClock.frame, "An update to Alarm clock is available. Do you want to update now?", "Update available", JOptionPane.YES_NO_OPTION);
				...
				CMenuBar.updateAlarmClock.doClick();
			}
